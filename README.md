...
<div align="center">
  ...
  <h1>Le-data</h1>
  <p>Generate placeholder data for testing and development. Made with indian touch in it.</p>

  [![code size](https://img.shields.io/github/languages/code-size/ajayff4/-ajayff4-le-data)](https://github.com/Ajayff4/-ajayff4-le-data)
  [![activity](https://img.shields.io/github/commit-activity/w/ajayff4/-ajayff4-le-data)](https://github.com/Ajayff4/-ajayff4-le-data)
  [![repo size](https://img.shields.io/github/repo-size/ajayff4/-ajayff4-le-data)](https://github.com/Ajayff4/-ajayff4-le-data)
